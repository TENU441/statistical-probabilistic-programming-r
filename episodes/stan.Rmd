...
dir.create("stan_compiled", showWarnings = FALSE)

options(cmdstanr_write_stan_file_dir = file.path(getwd(), "stan_compiled"))
options(cmdstanr_write_exe_dir = file.path(getwd(), "stan_compiled"))
